...
function HomePage() {
  ...
  return (
    <>
      <Head>
        <title>{`Beyaz Partners`}</title>

        <meta
          name="description"
          content="Beyaz Partners: Building Exceptional Lawyer Sites Tailored to Your Needs, Ensuring Your Legal Expertise is Presented Professionally and Elegantly"
        />
      </Head>
      <ConfigureCodeBanner
      ...
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1642911353098-42efaae7f6d4?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHxsYXd5ZXJ8ZW58MHx8fHwxNjk1MzE4MDY3fDA&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
          ...
          <Box position="absolute" top="0" backgroundColor="rgba(0,0,0,0.6)" width="100%" py="2">
            <Text align="center" fontSize="sm" color="white">
              Photo by{' '}
              <Link
                href="https://unsplash.com/@rmvisuals?utm_source=roq-generator&utm_medium=referral"
                isExternal
                color="teal.200"
              >{`Renaldo Matamoro`}</Link>{' '}
              on{' '}
              <Link
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Beyaz Partners: Building Exceptional Lawyer Sites Tailored to Your Needs, Ensuring Your Legal Expertise is Presented Professionally and Elegantly`}
            </Text>
            <Box
